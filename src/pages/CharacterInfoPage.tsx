...
export default function CharacterInfoPage() {
	...
	return (
		<div className='h-full flex flex-col-reverse md:flex-col'>
			{/* Submenu: */}
			<div className='animate-secondaryMenuSlideUp md:animate-secondaryMenuSlideDown h-12 bg-blue-800 text-white px-3 rounded-t md:rounded-t-none md:rounded-b flex items-center sticky bottom-0 md:top-0 md:bottom-auto flex-shrink-0'>
				<Container>
